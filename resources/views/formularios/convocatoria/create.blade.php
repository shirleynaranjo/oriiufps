    ...
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"> Crear Convocatoria </h3>
            ...
            <form action="{{route('guardar_convocatoria')}}" id="form-general" class="form-horizontal" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="nombreConvocatoria" id="nombreConvocatoria" class="form-control"
                                    value="{{old('nombreConvocatoria')}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="oferenteConvocatoria" id="oferenteConvocatoria" class="form-control"
                                    value="{{old('oferenteConvocatoria')}}" required>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="input-group date">
                                <div class="input-group-addon">
                                    ...
                                    value="{{old('vigenciaConvocatoria')}}" required>
                            </div>
                        </div>
                    </div>   
